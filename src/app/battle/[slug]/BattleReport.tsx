...
type Props = {
  initialFightData: FightDataRecord;
  slug: string;
};

export default function BattleReport({ initialFightData, slug }: Props) {
  const [fightData, setFightData] = useState<FightDataRecord>(initialFightData);
